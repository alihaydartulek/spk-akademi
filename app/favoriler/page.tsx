        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-6 py-16">
            <div className="bg-slate-800 rounded-3xl p-10 border border-slate-700 shadow-2xl text-center max-w-md w-full">
              ...
              <p className="text-slate-400 mb-8">{miniSorular.length} soru · Favorilerimden</p>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-4 py-3 rounded-xl font-semibold shadow-lg transition"
                >
                  🔄 Tekrar
                </button>
                <button
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 flex flex-col">
        ...
        <nav className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50">
          <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-amber-500/30">⭐</div>
              <div>
                <div className="font-bold text-white text-sm leading-none">Favori Mini Sınav</div>
        ...
        <div className="flex-1 max-w-3xl mx-auto px-6 py-10 w-full">
          ...
          {/* Soru kartı */}
          <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700 shadow-xl shadow-blue-900/20 mb-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border-2 transition flex items-start gap-3 ${
                      gosterDogru
                        ...
                        : "bg-slate-900/50 border-slate-700 hover:border-blue-400/40 hover:bg-blue-500/5 text-slate-300"
                    } ${miniGoster ? "cursor-default" : "cursor-pointer"}`}
                  >
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-bold text-sm flex-shrink-0 ${
                      gosterDogru ? "bg-emerald-500 text-white" : gosterYanlis ? "bg-red-500 text-white" : secili ? "bg-blue-500 text-white" : "bg-slate-700 text-slate-300"
                    }`}>
                      {opt.id}
                    </div>
          ...
          <div className="flex justify-between items-center">
            <div className="text-sm text-slate-400">
              {miniDogru} doğru · {miniIdx - miniDogru + (miniGoster && miniSecim !== dogruId ? 1 : 0)} yanlış
            </div>
            <button
              onClick={miniIleri}
              disabled={!miniSecim}
              className={`px-6 py-3 rounded-xl font-semibold transition shadow-lg ${
                miniSecim
                  ? "bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white shadow-blue-500/30 hover:scale-105"
          ...
          <div className="space-y-4">
            {favoriler.length === 0 ? (
              <div className="bg-slate-800 rounded-2xl p-12 text-center border border-slate-700">
                ...
                <Link href="/dashboard" className="inline-block bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-6 py-3 rounded-lg font-semibold shadow-lg shadow-blue-500/40 transition">
                  Çalışmaya Başla
                </Link>
              </div>
            ) : (
    ...
    <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-xl shadow-blue-900/30">
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex-1">
          <div className="text-xs text-blue-300 mb-1 font-medium">{favori.modulBaslik} · {favori.dersBaslik}</div>
      ...
      <div className="ml-14 mt-4">
        {!gosterCevap ? (
          <button
            ...
            className="bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-4 py-2 rounded-lg text-sm font-semibold transition"
          >
            Cevabı Göster
          </button>
        ) : (
