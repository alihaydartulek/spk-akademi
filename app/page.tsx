  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-slate-900 relative">
      ...
      <nav className="sticky top-0 z-50 bg-slate-900/80 glass border-b border-slate-700/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group flex-shrink-0">
            <div className="w-11 h-11 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-500/40">
              SPK
            </div>
            <div>
              <div className="font-bold text-white text-lg leading-none">SPK Akademi</div>
              <div className="text-[11px] text-blue-300 mt-1 tracking-wider uppercase">Lisanslama Platformu</div>
            </div>
          </Link>

          {/* Desktop nav */}
          <div className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
            <a href="#moduller" className="hover:text-blue-400 transition">Modüller</a>
            <Link href="/sinav" className="hover:text-blue-400 transition">Hızlı Pratik</Link>
            ...
            >
              <button
                ...
                className={`flex items-center gap-1.5 font-semibold transition ${sinavMenuAcik ? "text-blue-400" : "text-slate-300 hover:text-blue-400"}`}
              >
                Sınavlar
                <svg
                  className={`w-3.5 h-3.5 transition-transform duration-200 ${sinavMenuAcik ? "rotate-180 text-blue-400" : ""}`}
              ...
              <div className={`absolute top-full left-1/2 -translate-x-1/2 mt-3 w-[520px] transition-all duration-200 origin-top ${
                ...
                <div className="bg-slate-900 border border-slate-700/70 rounded-2xl shadow-2xl shadow-blue-900/40 overflow-hidden">
                  {/* Başlık */}
                  <div className="px-5 py-3.5 border-b border-slate-700/60 flex items-center gap-2">
                    ...
                    <span className="ml-auto px-2 py-0.5 text-[10px] font-bold bg-blue-500/15 text-blue-400 rounded-full border border-blue-500/25">8 Sınav Türü</span>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-px bg-slate-800/40 p-1">
                    {SINAV_MENUSU.map((sinav) => (
                      <Link
                        ...
                        className="group flex items-start gap-3 px-4 py-3.5 rounded-xl bg-slate-900 hover:bg-blue-500/8 transition-all"
                      >
                        ...
                        <svg className="w-4 h-4 text-blue-500 opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all ml-auto flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link href="/favoriler" className="hover:text-blue-400 transition">Favoriler</Link>
            <Link href="/istatistikler" className="hover:text-blue-400 transition">İstatistikler</Link>
            <Link href="/dashboard" className="bg-gradient-to-br from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white px-5 py-2.5 rounded-lg font-semibold shadow-lg shadow-blue-500/40 transition-all hover:scale-105">
              Çalışmaya Başla
            </Link>
          </div>
          ...
          <div className="md:hidden flex items-center gap-3">
            ...
            <Link href="/dashboard" className="bg-gradient-to-br from-blue-500 to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold">Başla</Link>
          </div>
        </div>
              ...
              <div className="pt-3 mt-2 border-t border-slate-700/60">
                ...
                {SINAV_MENUSU.map((sinav) => (
                  <Link
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-blue-500/8 border border-blue-500/20 mb-1 hover:bg-blue-500/15 transition"
                  >
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span className="text-sm font-semibold text-blue-300">{sinav.ad}</span>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-cyan-500/15 rounded-full blur-3xl" />
        <div className="relative max-w-7xl mx-auto px-6 py-28 lg:py-36">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-400/30 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm text-blue-100 font-medium">SPK Sermaye Piyasası Lisanslama · Tüm Sınavlar</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.05] tracking-tight">
              Türkiye'nin<br />
              <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-400 bg-clip-text text-transparent">En Kapsamlı</span>{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <Link href="/sinav" className="bg-blue-500/10 hover:bg-blue-500/20 border border-blue-400/30 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105">
                ⏱️ Sınav Simülasyonu
              </Link>
            </div>
            <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto pt-10 border-t border-slate-700/50">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-blue-300 uppercase tracking-[0.2em] font-medium">Modül</div>
              </div>
              <div className="text-center border-x border-slate-700/50">
                <div className="text-4xl md:text-6xl font-bold text-white mb-2">{animDers}</div>
                <div className="text-xs md:text-sm text-blue-300 uppercase tracking-[0.2em] font-medium">Ders</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-6xl font-bold text-white mb-2">{animSoru}</div>
                <div className="text-xs md:text-sm text-blue-300 uppercase tracking-[0.2em] font-medium">Soru</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="moduller" className="py-24 relative">
        <div className="relative max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative mb-4">
                <input
                  ...
                  className="w-full px-6 py-4 pl-14 bg-slate-800 border border-slate-700 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:ring-4 focus:ring-blue-500/20 transition-all shadow-xl shadow-blue-900/30"
                />
                <svg className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {(aramaMetni || sinavFiltre) && (
                <div className="mt-4 text-sm text-slate-300 text-center">
                  ...
                  {sinavFiltre && <span> · <span className="font-semibold text-blue-300">{SINAVLAR.find((s) => s.kod === sinavFiltre)?.ad}</span> sınavı için</span>}
                </div>
              )}
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-11 h-11 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-500/50">
                      {String(idx + 1).padStart(2, "0")}
                    </div>
                    <span className="px-2.5 py-1 bg-blue-500/10 text-blue-300 text-xs font-semibold rounded-md border border-blue-400/30">
                      {modul.lessons.length} Ders
                    </span>
                  </div>
                  <h3 className="font-bold text-white text-lg mb-3 leading-tight group-hover:text-blue-300 transition line-clamp-2 min-h-[56px]">
                  ...
                  {mounted && (
                    <div className="mb-4">
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        ...
                        <span className={`font-bold ${ilerleme === 100 ? "text-emerald-400" : "text-blue-400"}`}>
                  ...
                  <div className="space-y-1.5 mb-5">
                    ...
                    {modul.lessons.length > 2 && (
                      <div className="text-xs text-blue-400 pl-3 font-medium">+ {modul.lessons.length - 2} ders daha</div>
                    )}
                  </div>
                  <div className="flex items-center justify-between pt-4 border-t border-slate-700">
                    <div className="flex items-baseline gap-1.5 text-sm">
                      <span className="text-lg font-bold text-blue-400">{toplamSoruSayisi}</span>
          ...
          {filtrelenmisModuller.length === 0 && (
            <div className="text-center py-16 bg-slate-800 rounded-2xl border border-slate-700 shadow-xl shadow-blue-900/30">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t, idx) => (
              <div key={idx} className="bg-slate-800 rounded-2xl p-6 border border-slate-700 shadow-xl shadow-blue-900/30">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-slate-700">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center text-white font-semibold">{t.isim.charAt(0)}</div>
                    <div>
                      <div className="font-semibold text-white text-sm">{t.isim}</div>
                      <div className="text-xs text-slate-400">{t.rol}</div>
                    </div>
                  </div>
                  <span className="px-2 py-1 bg-blue-500/10 text-blue-300 rounded-md text-xs font-semibold border border-blue-400/30">{t.sinav}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-11 h-11 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center text-white font-bold text-sm">SPK</div>
                <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {SINAV_MENUSU.map((sinav) => (
                  <li key={sinav.href}>
                    <Link href={sinav.href} className="flex items-center gap-2 text-blue-300 hover:text-blue-200 font-medium transition">
